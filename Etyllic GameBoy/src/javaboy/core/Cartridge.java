	...
	public InputStream openRom(String romFileName) {
		...
		if (bFormat == bZip) { 
			...
			try {
				...
				zip = new java.util.zip.ZipInputStream(new java.net.URL(romFileName).openStream());
		...
		if (bFormat == bGZip) {
			...
			try {
				...
				return new java.util.zip.GZIPInputStream( new java.util.zip.ZipInputStream(new java.net.URL(romFileName).openStream()));
			} catch (Exception e) {
