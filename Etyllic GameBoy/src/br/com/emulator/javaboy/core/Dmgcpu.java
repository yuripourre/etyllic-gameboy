...
public class Dmgcpu extends Thread{
   ...
   System.out.println(hexWord(data) + " written to " + hexWord(addr) + " at " + hexWord(pc) + " bank " + cartridge.currentBank);
  }
  if ((addr >= 0xEFF8) && (addr <= 0xEFF8) && (running)) {
   ...
   System.out.println(hexWord(addr) + " written at " + hexWord(pc) + " bank " + cartridge.currentBank);
  }*/
